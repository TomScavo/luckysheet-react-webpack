...
function luckysheetDrawgridColumnTitle(scrollWidth, drawWidth, offsetLeft) {
    ...
    for (let c = dataset_col_st; c <= dataset_col_ed; c++) {
        ...
        if (Store.config["colhidden"] != null && Store.config["colhidden"][c] != null) {
            ...
            let textMetrics = getMeasureText('配置表11111111111111111', luckysheetTableContent);
            ...
            luckysheetTableContent.fillText('配置表11111111111111111', horizonAlignPos/Store.zoomRatio, verticalAlignPos/Store.zoomRatio);
            luckysheetTableContent.restore();//restore scale after draw text
        }
